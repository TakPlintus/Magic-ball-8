...
window = Tk()
window.title('Magic ball 8')
window.resizable(False, False)
window.iconbitmap('icon.ico')
c = Canvas(width=600, height=500, bg='darkgrey')
c.pack()
...
c.create_text(300, 135, text='Magic!', fill='white', font='a_ModernoCaps', tag='ball')
c.create_polygon((200, 340), (240, 280), (360, 280), (400, 340),
                 fill='black')

c.create_line(-5, 450, 605, 450, width=4)
c.create_line(-5, 410, 605, 410, width=4)
future_text = c.create_text(30, 430,
                            text='', fill='yellow', font='a_ModernoCaps 20', anchor=W)


c.create_line(-5, 480, 100, 480, width=4)
c.create_line(99, 480, 120, 450, width=4)
c.create_text(6, 465,
              text='by TakPlintus', fill='yellow', font='a_ModernoCaps', anchor=W)
